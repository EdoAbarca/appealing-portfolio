...
const Contact = () => {
	const socialLinks = [
		{
			href: 'https://www.github.com/EdoAbarca',
		...
		{
			href: 'https://www.linkedin.com/in/eduardo-abarca-chavez-01374a324/',
			icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		},
		{
			...
			icon: (
				...
				>
					<path
						d="M12.5 12.5L3 6.75V17.25C3 18.2165 3.7835 19 4.75 19H20.25C21.2165 19 22 18.2165 22 17.25V6.75L12.5 12.5ZM12.5 11L21.5 5.25H3.5L12.5 11ZM20.25 5C21.2165 5 22 5.7835 22 6.75V17.25C22 18.2165 21.2165 19 20.25 19H4.75C3.7835 19 3 18.2165 3 17.25V6.75C3 5.7835 3.7835 5 4.75 5H20.25Z"
						fill="currentColor"
					/>
				</svg>
			),
	...
	return (
		<section id="contact" className="section">
			<div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
				...
				<form action="https://getform.io/f/bnlljolb" method="POST" className="xl:pl-10 2xl:pl-20">
					<div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
						...
						<div className="mb-4">
							<label htmlFor="message" className="label">Name</label>
							<textarea
							name="message"
							id="message"
							required
